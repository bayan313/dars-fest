...
const studentSchema = new mongoose.Schema({ id: String, name: String, chestNo: String, teamId: String, category: String, photo: String });
...
const appealSchema = new mongoose.Schema({ id: String, studentName: String, team: String, category: String, programme: String, phoneNumber: String, description: String, fee: { type: Number, default: 50 }, status: String, response: String, date: String });
...
const settingsSchema = new mongoose.Schema({ prospectusUrl: String, adminPassword: String, revision: { type: Number, default: 0 } });
...
async function syncAdminPassword() {
  try {
    ...
    if (!settings) {
      await Settings.create({ adminPassword: FIXED, revision: 0 });
